...
_TAFSIR_ELIGIBLE_ROUTE_TYPES = {AskRouteType.EXPLICIT_QURAN_REFERENCE.value}


def build_quran_source_policy(
    *,
    requested_text_source_id: str | None,
    requested_translation_source_id: str | None,
    selected_text_source_id: str | None,
    selected_translation_source_id: str | None,
    text_source_origin: str | None,
    translation_source_origin: str | None,
) -> QuranSourcePolicyDecision:
    allowed = bool(selected_text_source_id)
    return QuranSourcePolicyDecision(
        allowed=allowed,
        included=allowed,
        policy_reason='selected' if allowed else 'missing_selected_quran_source',
...
def evaluate_ask_source_policy(
    *,
    route_type: str,
    include_tafsir: bool | None,
    tafsir_intent_detected: bool,
    requested_tafsir_source_id: str | None,
    quran_source: SourceRecord | None,
    requested_quran_text_source_id: str | None,
    requested_quran_translation_source_id: str | None,
    selected_quran_text_source_id: str | None,
    selected_quran_translation_source_id: str | None,
    quran_text_source_origin: str | None,
    quran_translation_source_origin: str | None,
    ...
    selected_tafsir = resolve_tafsir_source_for_explain(
        requested_tafsir_source_id if tafsir_policy.request_origin == 'explicit_flag' else None,

...
def test_evaluate_ask_source_policy_allows_multiple_tafsir_sources_for_explicit_quran_explain() -> None:
    quran_source = get_source_record('quran:tanzil-simple')
    ...
    policy = evaluate_ask_source_policy(
        ...
        tafsir_intent_detected=True,
        requested_tafsir_source_id=None,
        requested_tafsir_source_ids=['tafsir:ibn-kathir-en', 'tafsir:tafheem-al-quran-en'],
        quran_source=quran_source,
        requested_quran_text_source_id='quran:tanzil-simple',
        requested_quran_translation_source_id='quran:towards-understanding-en',
        selected_quran_text_source_id='quran:tanzil-simple',
    ...
    assert policy.tafsir.included is True
    assert policy.tafsir.selected_source_id == 'tafsir:ibn-kathir-en'
    assert policy.tafsir.selected_source_ids == ['tafsir:ibn-kathir-en', 'tafsir:tafheem-al-quran-en']
    assert policy.tafsir.policy_reason == 'selected_multiple'


def test_evaluate_ask_source_policy_defaults_to_three_comparative_tafsir_sources_when_requested_without_specific_source_ids() -> None:
    quran_source = get_source_record('quran:tanzil-simple')
    ...
    assert policy.tafsir.allowed is True
    assert policy.tafsir.included is True
    assert policy.tafsir.selected_source_ids == [
